    ...
    async function fetchTourData() {
      try {
        const { data } = await axios.get(
          `https://67ddc7a0471aaaa742828494.mockapi.io/items?destination=${destination}`,
        );
        setTourData(data[0]);
      } catch (error) {
    ...
    <div className="wrapper">
      ...
      <div className="fullTour">
              ...
              <div className="city__date">
                ...
                <div className="date">
                  <svg
                    ...
                    <g>
                      <path
                        d="M17.0736 4.17651H6.00333C3.96535 4.17651 2.31323 5.82863 2.31323 7.86661V17.0919C2.31323 19.1298 3.96535 20.7819 6.00333 20.7819H17.0736C19.1116 20.7819 20.7637 19.1298 20.7637 17.0919V7.86661C20.7637 5.82863 19.1116 4.17651 17.0736 4.17651Z"
                        stroke="black"
                        strokeWidth="2.21406"
                        strokeLinecap="round"
                      ...
                      />
                      <path
                        d="M2.31323 9.71161H20.7637M7.84838 2.33142V6.02152V2.33142ZM15.2286 2.33142V6.02152V2.33142Z"
                        stroke="black"
                        strokeWidth="2.21406"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  <p>
                    {tourData.dateEntry} - {tourData.dateExit}
                  </p>
                </div>
              </div>
            ...
            <div className="days">
              <div className="days__inner">
                <img
                  width={40}
                  height={40}
                  style={{ filter: 'drop-shadow(0px 0px 7px #f8ea22)' }}
                  src="/img/tourSvg/sun.png"
                  alt="Дни"
                />
              ...
              <div className="days__inner">
                <img
                  width={40}
                  height={40}
                  style={{ filter: 'drop-shadow(-2px 2px 7px #213775)' }}
                  src="/img/tourSvg/moon.png"
                  alt="Ночи"
                />
        ...
        <div className="fullTour__bottom">
          ...
          <div className="book">
            <button onClick={onClickAdd} className="book__button">
              Забронировать тур
            </button>
            <div className="price">
              <p>₽{formatNumber(tourData.price)}</p>
              <div className="price__desc">За человека</div>
            </div>
          </div>
        </div>
      </div>
